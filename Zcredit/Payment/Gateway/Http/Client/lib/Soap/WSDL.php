...
class WSDL extends \Zcredit\Payment\Gateway\Http\Client\lib\Soap\ZcreditBase {
    ...
    function parseWSDL($wsdl = '') {
        ...
        if (isset($wsdl_props['scheme']) && ($wsdl_props['scheme'] == 'http' || $wsdl_props['scheme'] == 'https')) {
            ...
            // get wsdl
            $tr = new \Zcredit\Payment\Gateway\Http\Client\lib\Soap\SoapTransportHttp($wsdl, $this->curl_options, $this->use_curl);
    ...
    function start_element($parser, $name, $attrs)
    {
        if ($this->status == 'schema') {
            ...
            $this->status = 'schema';
            $this->currentSchema = new \Zcredit\Payment\Gateway\Http\Client\lib\Soap\NuSoapXmlSchema('', '', $this->namespaces);
            $this->currentSchema->schemaStartElement($parser, $name, $attrs);
            $this->appendDebug($this->currentSchema->getDebug());
            $this->currentSchema->clearDebug();
        } else {
